...
# Base URL
REST_URL = "https://api.upbit.{}/api/"
WSS_URL = "wss://api.upbit.{}/websocket"
...
UPBIT_USER_STREAM_PATH_URL = "/userDataStream"
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=SNAPSHOT_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 50),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
    RateLimit(limit_id=UPBIT_USER_STREAM_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
